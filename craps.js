...
BetManager.prototype = {
  ...
  displayBets: function(){
    ...
    headers.append($(document.createElement('th')).append($(document.createElement('i')).attr('title', 'Bet Id').attr('class', 'icon-qrcode icon-large')))//.html('Id'))
           ...
           .append($(document.createElement('th')).width($('#buffer').width()*(0.03)).append($(document.createElement('i')).attr('title', 'Bet On?').attr('class', 'icon-off icon-large')))//.html('On?'))
           .append($(document.createElement('th')).width($('#buffer').width()*(0.03)).append($(document.createElement('i')).attr('title', 'Repeat On Win?').attr('class', 'icon-repeat icon-large')))//.html('Repeat?'))
           ...
           .append($(document.createElement('th')).width($('#buffer').width()*(0.03)).attr('onclick', 'reset()').append($(document.createElement('i')).attr('title', 'Remove All Bets').attr('class', 'icon-eraser icon-large').css({color:'#f00', cursor:'pointer'})));//.html('Rem All'));
